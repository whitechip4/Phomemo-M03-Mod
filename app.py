...
def print_img(img_path):
    ...
    #COM PORT OPEN (今決め打ち)
    com = serial.Serial("COM3",115200,timeout=1)
        ...
        while True:
            ...
            if img_num > 0:
                ...
                if ext == 'png' or ext == 'jpg' or ext == 'gif' :
                    ...
                    print("Print Finished -> " + observe_dir_path+"/ok/"+os.path.basename(trg_path))
                else:
                    shutil.move(trg_path, observe_dir_path+"/ng/"+os.path.basename(trg_path))
                    print("Cannot print -> " + observe_dir_path+"/ng/"+os.path.basename(trg_path))
                print("")
